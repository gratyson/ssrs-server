...
INSERT INTO word_elements(
	id, name, abbreviation, weight, apply_language_font, test_time_multiplier)
	VALUES ('kana', 'Kana', 'Kana', 2, true, null);

INSERT INTO word_elements(
	id, name, abbreviation, weight, apply_language_font, test_time_multiplier)
	VALUES ('kanji', 'Kanji', 'Kanji', 2, true, 2);

INSERT INTO word_elements(
	id, name, abbreviation, weight, apply_language_font, test_time_multiplier)
	VALUES ('alt_kanji', 'Alternate Kanji', 'Alt Kanji', 2, true, null);

INSERT INTO word_elements(
	id, name, abbreviation, weight, apply_language_font, test_time_multiplier)
	VALUES ('meaning', 'Meaning', 'Meaning', 5, false, null);

INSERT INTO language_elements(
	language_id, word_element_id, required, core, ordinal, dedupe)
	VALUES (1, 'kana', true, true, 1, true);

INSERT INTO language_elements(
	language_id, word_element_id, required, core, ordinal, dedupe)
	VALUES (1, 'meaning', true, true, 2, false);

INSERT INTO language_elements(
	language_id, word_element_id, required, core, ordinal, dedupe)
	VALUES (1, 'kanji', false, true, 3, true);

INSERT INTO language_elements(
	language_id, word_element_id, required, core, ordinal, dedupe)
	VALUES (1, 'alt_kanji', false, false, 4, false);
