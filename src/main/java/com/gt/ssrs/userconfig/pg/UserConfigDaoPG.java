package com.gt.ssrs.userconfig.pg;
...
@Component
public class UserConfigDaoPG implements UserConfigDao {

    private static final Logger log = LoggerFactory.getLogger(UserConfigDaoPG.class);

    private NamedParameterJdbcTemplate template;

    @Autowired
    public UserConfigDaoPG(NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
