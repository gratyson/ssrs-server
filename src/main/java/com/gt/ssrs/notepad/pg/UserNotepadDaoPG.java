package com.gt.ssrs.notepad.pg;
...
@Component
public class UserNotepadDaoPG implements UserNotepadDao {
    private static final Logger log = LoggerFactory.getLogger(UserNotepadDaoPG.class);

    private NamedParameterJdbcTemplate template;

    @Autowired
    public UserNotepadDaoPG(NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
