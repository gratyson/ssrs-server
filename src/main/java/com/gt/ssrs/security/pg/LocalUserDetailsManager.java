...
public class LocalUserDetailsManager implements UserDetailsManager {
    ...
    public void createUser(UserDetails user) {
        localUserDao.createLocalUser(LocalUser.newUserWithCredentials(user.getUsername(), passwordEncoder.encode(user.getPassword())));
    }
    ...
    public void changePassword(String oldPassword, String newPassword) {
        ...
        localUserDao.setUserPassword(username, passwordEncoder.encode(newPassword));
    }
